...
const Login = () => {
    ...
    const [signInWithGoogle, name,loading2,error3] = useSignInWithGoogle(auth)
    ...
    return (
        <div className='mt-32 mb-10 w-full md:w-1/2 mx-auto custom-shadow bg-[#e8eaec] pt-10 pb-10 px-10 rounded-lg'>
            ...
            <p className="mt-5">
                ...
                New To Doctor-Portal ? <Link className='form-link' to='/register'><span className='text-red-700'>Create an Account</span></Link>
